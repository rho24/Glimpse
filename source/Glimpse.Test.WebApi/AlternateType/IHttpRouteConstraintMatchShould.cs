...
namespace Glimpse.Test.WebApi.AlternateType
{
    public class IHttpRouteConstraintMatchShould
    {
        ...
        {
            context.Setup(c => c.Arguments).Returns(new object[] { (System.Web.Http.HttpContextBase)null, new System.Web.Http.Routing.Route("Test", handler), (string)null, (System.Web.Routing.Http.RouteValueDictionary)null, System.Web.Http.Routing.RouteDirection.IncomingRequest });
            context.Setup(c => c.ReturnValue).Returns(true);
            context.Setup(c => c.InvocationTarget).Returns(new System.Web.Http.Routing.Route("Test", null));
