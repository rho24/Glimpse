...
{
    public class IActionHttpMethodProvider : AlternateType<System.Web.Http.Controllers.IActionHttpMethodProvider>
    {
        private IEnumerable<IAlternateMethod> allMethods;

        public IActionHttpMethodProvider(IProxyFactory proxyFactory)
            : base(proxyFactory)
        {
        }
        ...
        public class HttpMethods : AlternateMethod
        {
            public HttpMethods()
                : base(typeof(System.Web.Http.Controllers.IActionHttpMethodProvider), "HttpMethods")
            {
            }
